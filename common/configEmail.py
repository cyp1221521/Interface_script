...
class Email:
    ...
    def config_content(self):
        ...
        html_file =self.log.get_report_path()+"\\report.html"
        try:
            content_part = MIMEApplication(open(html_file,'rb').read())
        except:
            print("report file is not generated")
        else:
            content_part.add_header('Content-Disposition', 'attachment', filename="report.html")
            self.msg.attach(content_part)
